        ...
        <View style={styles.container}>
            <View style={styles.profileHeader}>
                <View style={styles.profileImageContainer}>
                    <Image
                        source={{ uri: 'https://t4.ftcdn.net/jpg/05/48/04/81/360_F_548048113_MmHtOeLafIlaWYWaeueiCxBGb9EA50gb.jpg' }}
                        style={styles.profileImage}
                    />
                </View>
                <Text style={styles.name}>Sana Afzal</Text>
                <TouchableOpacity style={styles.emailButton}>
                    <Text style={styles.emailText}>sanaafzal291@gmail.com</Text>
                </TouchableOpacity>
            </View>
